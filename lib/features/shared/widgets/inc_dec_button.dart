    ...
    return Row(
      ...
      children: [
        _iconButton(
          ...
          disable: _counter <= widget.minCount
        ),
        ...
        _iconButton(
          ...
          }, disable: _counter  >= widget.maxCount,
        ),
      ],
    );
  }

  Widget _iconButton({required IconData icon, required VoidCallback onTap, required bool disable}) {
